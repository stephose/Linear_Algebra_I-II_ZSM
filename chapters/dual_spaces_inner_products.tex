...
\begin{proof}
	...
	\]
	By a previous result, this shows that $u1 = u_2$. This shows that $\Phi$ is surjective and injective.
	...
	For $K = \mathbb{C}$, we have that the hermitian product $\langle \cdot , \cdot \rangle$ is $\mathbb{C}$-atnilinear in the second variable. So, it follows that $\Phi$ is also $\mathbb{C}$-antilinear.
\end{proof}
