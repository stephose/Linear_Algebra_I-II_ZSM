...
\begin{proof}
	...
	\[
		\begin{pmatrix}
			\rule[0.5ex]{1em}{0.4pt} & \varepsilon_{\sigma 1} & \rule[0.5ex]{1em}{0.4pt}\\
			& \vdots & \\
			\rule[0.5ex]{1em}{0.4pt} & \varepsilon_{\sigma n} & \rule[0.5ex]{1em}{0.4pt}
		\end{pmatrix}
	\]
...
\begin{proof}
	...
	\]
	Clearly, by the rules of matrix multiplication, for every two row vectors $\alpha_i, \alpha_i'$ we have that $(\alpha_i + \alpha_i') B = \alpha_i B + \alpha_i' B$ and
	\[
